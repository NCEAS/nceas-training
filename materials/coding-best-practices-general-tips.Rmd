...
- **keep it simple, stupid (KISS)**. Do not create overly complicated statements. Implement your tasks in several simple lines instead of embedding a lot of executions in one complicated line. It will save you time while debugging and make your code more readable to others
...
## Solutions to function challenge
...
- Functional programming in R: https://adv-r.hadley.nz/fp.html
...
- [A good overview by H. Wickham](https://style.tidyverse.org/functions.htmll) of the best practices regarding best syntax to us in R from Hadley Wickham.
