...
This resource is provided as a self guided onboarding document that new postdocs should work through in the first weeks of joining NEON. The information contained in this document builds on the experience of ecological reserchers, traininers, developers and information managers in collaborative, reproducoible reseaech practices and infrastructure. 

When working through the technical training piece you will be using the following software. Please be sure these are all installed on your laptop. 
