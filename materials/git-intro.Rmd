...
knitr::include_graphics("materials/images/rstudio-project.png")
```
2. Choose *Version Control*  
```{r RStudio project version control panel, out.width='50%', fig.align='center', echo = FALSE}
knitr::include_graphics("materials/images/rstudio-project-version-control.png")
```
3. Select `git`
...
knitr::include_graphics("materials/images/rstudio-project-clone.png")
```
...
knitr::include_graphics("materials/images/repo-cloned.png")
```
...
knitr::include_graphics("materials/images/repo-finder-view.png")
```
...
knitr::include_graphics("materials/images/rstudio-files-view.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-panel.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-icons.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-diff.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-readme.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-panel-modified.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-diff-readme.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-first-commit.png")
```
...
knitr::include_graphics("materials/images/rstudio-git-history.png")
```
...
knitr::include_graphics("materials/images/repo-not-synched.png")
```
...
knitr::include_graphics("materials/images/repo-synched.png")
```
