...
![](images/github-cloud-with-repo.png)
...
![](images/git-intro-first-commit.png)
...
![](images/version-graph_mattJones.png)
...
```{r RStudio git icons, out.width='80%', fig.align='left', echo = FALSE}
...
repository, add some code, and then save it.
