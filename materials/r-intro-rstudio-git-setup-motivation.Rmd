...
Most of the envrionemental sciences research is done in a collaborative set up. This especially true in the synthesis working group model that NCEAS has been using and refining over the years. These groups of experts with different background, tools and methods, have to collaborate together and build on others work, paticularly data.

In this tight collaborative setup, we recommend to manage your data and codes using the following approach to amange your collaboration on an server / remote machine.
