...
**Note: typing is not your thing? the `<tab>` key is your friend!** One hit it will autocomplete the file/directory/path name for you. If there are many options, hit it twice to see the options.
...
You have several options to upload files to the server. Some are more convenient if you have few files, like RStusio interface, some are more built for uploading a lot of files at one, like specific software... and you guessed it the CLI!
...
An efficient protocole to upload files is FTP (File Transfer Protocol). The `s` stands for secured. Any software supporting those protocoles will work to transfer files. 
