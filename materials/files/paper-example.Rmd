...
author: ["Bryce Mecum, mecum@nceas.ucsb.edu", "Matt Jones, jones@nceas.ucsb.edu"]
output:
  html_document:
    fig_caption: yes
  pdf_document:
...
```{r pricevscarat, echo=FALSE, fig.cap="The relationship between price and carat for the diamonds dataset.", fig.width=8, fig.height=4, fig.align='center', cache=TRUE}
