...
* Go to [this dataset](https://dev.nceas.ucsb.edu/view/urn:uuid:6f07cb25-a4a1-48e8-95cb-74f532f3ce2d), right click the download button, and select copy link address  
* From the terminal, make and navigate to a directory called `data` in your project directory   
    *  `mkdir data`, `cd data`  
* Use `wget` to download the zip into the data directory  
...
```{r plot, eval = F}
write_sf(pop_region_3338, "data/shapefiles/ak_regions_population.shp", delete_layer = TRUE)
```
