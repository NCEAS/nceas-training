...
`training-test.Rproj` are still listed as having not been committed.  This means
...
![](images/RStudio_project_switcher.png)
...
* created a default branch called "main"
* pushed the main branch to the remote
