...
git repository can be cloned so that it exists both locally, and remotely.  But each of
...
a git repository as a folder with a bunch of additional version-related metadata.
...
```
git remote add origin https://github.com/jeanetteclark/training_dolinh.git
git branch -M main
