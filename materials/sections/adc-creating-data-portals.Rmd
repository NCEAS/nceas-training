...
There are two methods to create portals on our site, both of which require being logged in. If you are on the [Arctic Data Center's primary website](http://arcticdata.io/), hover over the 'Data' tab, and select the 'Portals' option. This will take you to the [Portals page](https://arcticdata.io/catalog/portals) where you can view all public portals. If you are logged in, you will be able to see the button labeled '+ New Portal', which will then take you directly to the page where you can start customizing your portal.

![](images/arctic-data-center/ADC-createportal1.png)
![](images/arctic-data-center/ADC-createportal2.png)

Alternatively, if you are logged in with your ORCID and on the [Dataset Search](https://arcticdata.io/catalog) page, you can also get to the page to create a new portal by hovering on your name in the upper right hand corner. From there, a dropdown will appear and you can select 'My Portals'.

![](images/arctic-data-center/ADC-createportal3.png)
...
![](images/arctic-data-center/ADC-createportal4.png)
...
![](images/arctic-data-center/ADC_portal_data_editor_1.png) We're going to start with the second section.
...
![](images/arctic-data-center/ADC-saveportal.png)

To delete a page from your portal, select the arrow in the tab you want to remove and choose 'Delete' from the dropdown.

![](images/arctic-data-center/ADC-delete.png)

Users can view and edit their portal from their 'My Portals' tab.

First, hover over your name in the top-right corner to drop down your menu options. Then, select 'My Portals' from the dropdown underneath your name. See the section on Getting Started with Portals for more details.

![](images/arctic-data-center/ADC-myportals.png) ![ADC-viewportal](images/arctic-data-center/ADC-viewportal2.png)
