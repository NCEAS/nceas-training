...
push their changes to the Owner's repository.  But before doing so, it's good practice
...
the changed index.Rmd file to be committed by clicking the checkbox next to it, 
