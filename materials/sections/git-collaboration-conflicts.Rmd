...
- Find a partner, and choose one person as the `Owner` and one as the `Collaborator`
...
Now it's your turn. With your partner, intentionally create a merge conflict, and then go 
