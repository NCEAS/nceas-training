...
::: callout-note
### Question 5
Find the mean using `mean()` of lobster carapace length, grouped by `SITE`. Think about how you want to treat the `NA` values in `SIZE_MM` (Hint: check the arguments in `mean()`). Check your output.
:::
