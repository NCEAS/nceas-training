...
Marginal sums and statistics also are not considered tidy, ad they are not the same type of observation as the other rows. Instead, they are a combination of observations.
...
Here is what our tidy data looks like:
