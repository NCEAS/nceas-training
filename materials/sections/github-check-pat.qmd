...
## Steps to check and set your Personal Access Token (PAT)

1. Log in to [included-crab](https://included-crab.nceas.ucsb.edu/)
2. Open the `Rproj` you are working in
...
2.  A new browser window should open up to GitHub, showing all the scopes options. You can review the scopes, but you don't need to worry about which ones to select this time. This function automatically pre-selects some recommended scopes. **Go ahead and scroll to the bottom and click "Generate Token"**.
