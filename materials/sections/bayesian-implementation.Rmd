...
In this lesson, we will explain and demonstrate how to 'translate' between statistical notation and model code, with particular emphasis on how to implement Bayesian models. 
