...
Open the R Markdown file `owner-analysis.Rmd` a. Check the `YAML` and add your name to the `author` field b. Create a new section with a level 2 header and title it "Exercise: Explore, Clean, and Wrangle Data" 2. Load the following libraries at the top of your R Markdown file
