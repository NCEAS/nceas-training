...
4. In Rstudio, create directory one called `data`and upload data into this folder:
5.  Open a new Quarto file
    ...
    c. <!-- create outline for analysis--> Create a new section with a level 2 header and title it "Exercise: Explore, Clean, and Wrangle Data"
