...
survey_raw <- read_csv(url_s, show_col_types = FALSE)
```
...
```{r, echo = FALSE}
url_q <- url("https://dev.nceas.ucsb.edu/knb/d1/mn/v2/object/urn%3Auuid%3A2aba2688-0861-46f3-b6b8-9796d618c9e9", method = "libcurl")

questions <- read_csv(url_q, show_col_types = FALSE, progress = FALSE)
