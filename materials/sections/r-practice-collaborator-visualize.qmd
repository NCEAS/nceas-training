...
## Run this chunk to test exercies ##
...
1. Go back to your visualization code and add some styling code (aka make your plots pretty!). Here's a list of functions to help you get started (this is not an exhaustive list!) or revisit the [data visualization lesson](https://learning.nceas.ucsb.edu/2023-04-coreR/session_12.html):
