...
- Understand of priors and how they can be used
- How to specify priors from expert knowledge  
- How to specify priors from (limited) data
- How to evaluate the impact of priors

### Background

Is there such a thing as a non-informative prior? Is a flat prior nothing?

When are priors necessary?
