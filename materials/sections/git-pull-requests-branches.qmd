...
You can now work on the `new-feature` branch in this new workspace independently of the codebase in `main`, and without affecting it. When you have finished and completed your changes, you can either decide to leave it there, delete it, or merge it back to main. To merge this new feature branch back, firat checkout the main branch, and then merge the feature branch back into it.
