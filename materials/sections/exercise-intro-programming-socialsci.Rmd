...
The goal for this session is to practice downloading data, reading it into R from an RMarkdown document, and using base R commands to summarize a variable within the dataset.
...
- create a new RMarkdown document, and read the data in
- explore the data
    + try `summary()`, `unique()`, `View()` 
