...
#### Reproducible Research: Recap {.unnumbered}
...
#### Computational Provenance and Workflows {.unnumbered}
...
To check out an example Binder, Ben Marwick (author of `rrtools`) has one for figures of of a paper he wrote at [benmarwick/JPA_Palaeolithic_Projectiles](https://github.com/benmarwick/JPA_Palaeolithic_Projectiles). As a warning, it may take a long time to spin up the image.

### The 5th Generation of Reproducible Papers {.unnumbered}
