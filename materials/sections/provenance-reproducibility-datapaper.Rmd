...
- Copy the example file [`paper.Rmd`](files/paper.Rmd) to `analysis/paper/paper.Rmd` in the project you built earlier
- Copy the example bibliography [`references.bib`](files/references.bib) to `analysis/paper/paper.Rmd` in the project you built earlier
...
```{r download-paper-example, eval=FALSE}
