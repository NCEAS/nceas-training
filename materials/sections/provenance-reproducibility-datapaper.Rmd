...
```{r eval=FALSE}
removes::install_github("benmarwick/rrtools")
...
[Reproducible Research for Synthesis Short Course Feedback](https://survey.az1.qualtrics.com/jfe/form/SV_5BkSwAVqbbvI9VA)

We are also collecting participant demographics, but separate from the feedback survey to preserve anonymity.

[Reproducible Research for Synthesis Short Course Participant Demographics](https://survey.az1.qualtrics.com/jfe/form/SV_bkqlAiziG79jcGi)
