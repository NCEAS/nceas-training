...
<!--This lesson aims to get you thinking about how to manage your data for a research or synthesis project. And how to do it with the FAIR and CARE principles in mind. We introduce multiple concepets and provide resources that you can come back to when ever you start a new project or to apply these principles to a project you are currently working on.-->
...
Data management, aims to provide a structure on how to organize all the data inputs and output along your research project. The goal is to avoid data chaos at all cost. The rule of thumb is that by every minute you spend managing your data, can save you 10 min of headache later (@briney2015).
...
Kristin Briney, Data Management for Researchers (@briney2015)
:::
