...
-   It is important to clearly determine the roles and responsibilities of each group member of he project. Roles may include data collection, data entry, QA/QC, metadata creation and management, backup, data preparation and submission to an archive, and systems administration.
...
Using the Logic Models you started on Monday, read the questions in [this document](https://docs.google.com/document/d/13zdYr6DzEt94r9UzKjemj2AL-FDr7RYvP6tuad-2gbs/edit). Answer as many as possible to the best of your knowledge. Identify which aspects of managing your data are easier to think about and which ones are more difficult, or you need more guidance.
...
- DMP Example: [Using NASA Remote Sensing Data to Reduce Uncertainty of Land-Use Transitions in
Global Carbon-Climate Models](https://daac.ornl.gov/datamanagement/Data_Management_Plan_Chini_NASA_TE.pdf)
