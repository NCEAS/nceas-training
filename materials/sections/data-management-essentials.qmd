...
UPDATE - Understand the importance of data management for successfully preserving data - Learn about metadata guidelines and best practices for reproducibility - Become familiar with environmental data repositories for accessing and publishing data

<!-- ## The Big Idea-->

## Introduction

Data management is the process of handling, organizing, documenting, and preserving data used in a project/research. This is particularly important in synthesis science given the nature of synthesis, where it involves combining data and information from multiple sources to answer broader questions, generate knowledge and provide insights into a particular problem or phenomenon.
...
The first step to working with data is identifying how the Data Life Cycle is going to look like for my project. Using the data life cycle stages, create your own cycle that best fits your project needs.

| Step | Description|
|------|------------|
| *Collect* | Observations are made either by hand or with sensors or other instruments, and the data are placed into digital form. You can structure the process of collecting data upfront to better implement data management. Assure Employ quality assurance and quality control procedures that enhance the quality of data (e.g., training participants, routine instrument calibration) and identify potential errors and techniques to address them.| 
|*Describe* | Document data by describing the why, who, what, when, where, and how of the data. Metadata, or data about data, is key to data sharing and reuse, and many tools, such as standards and software, are available to help describe data. Preserve Plan to preserve data in the short term to minimize potential losses (e.g., via accidents), and in the long term so that project stakeholders and others can access, interpret, and use the data in the future. Decide what data to preserve, where to preserve it, and what documentation needs to accompany the data.| 
...
**ADD LINK TO DataONE resources??**

<!--**DataONE Data Life Cycle Resources** 

-   [Best practices](https://dataoneorg.github.io/Education/bestpractices/) for each step in the cycle and guidelines to outline action items.
...
A you can see there is a lot happening around the Data Life Cycle. In order to better plan and keep track of all the moving pieces when working with data, a good place to start is creating a Data Management Plan. However, this is not only the starting point. This is a “living” document that should be consulted and updated throughout the project.
...
Most likely than not, a DMP will revise all phases of the Data Life Cycle.
...
- CREATE AN OUTLINE FOR A 2-PAGER plan
- Describe the 10 Rules
...
## Activity: Let's think about the Data Life C ycle for your project
