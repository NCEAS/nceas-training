...
-   Understanding metadata guidelines and best practices for reproducibility
-   Become familiar with environmental data repositories for accessing and publishing data
-   Interpret metadata for reusing data for synthesis science
...
The Data Life Cycle is a step-by-step breakdown of a research project into meaningful steps for facilitating successful management and preservation of data throughout a research project. Multiple versions of the data life cycle exist and vary in practice across projects. For example, a meta-analysis project may only focus on the Discover, Integrate, and Analyze phases of the cycle.
...
A first step to working with data is identifying where in the Data Life Cycle is my project starting at. DataOne's [Data Management Skillbuilding Hub](https://dataoneorg.github.io/Education/bestpractices/) offers several best practices on how to effectively work with your data throughout all stages of the data life cycle.
...
No matter where in the Data life cycle you are starting at, it is important to consider how are you going to manage your data.
...
"A data management plan (DMP) is a document describing the data a researcher will collect, quality assure, secure, describe, share, and archive over the course of a research project. DMPs are living documents and should be updated as research plans change to ensure new data management practices are captured."[EDI]. <!-- Add citation to EDI website---> **Often a DMP encompasses all phases of the Data Life Cycle** - from planning, to collecting, to analyzing and ultimately to preservation and storage of the data.
...
## Data Authors and Data Users

Withing the data life cycle you can be collecting data (creating new data) or integrating data that has all ready been collected. Either way, **metadata** plays plays a major role to successfully spin arond the cycle.
...
## Exercise: Evaluate a Data Package on the KNB Repository
...
-   **Group A:** EDI Data Portal [SBC LTER: Reef: Abundance, size and fishing effort for California Spiny Lobster (Panulirus interruptus), ongoing since 2012](https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-sbc.77.8)

-   **Group B:** EDI Data Portal [Physiological stress of American pika (Ochotona princeps) and associated habitat characteristics for Niwot Ridge, 2018 - 2019](https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-nwt.268.1)

-   **Group C:** EDI Data Portal [Ecological and social interactions in urban parks: bird surveys in local parks in the central Arizona-Phoenix metropolitan area](https://portal.edirepository.org/nis/mapbrowse?scope=knb-lter-cap&identifier=256&revision=10)

-   **Group D:** EDI Portal [North Temperate Lakes LTER: Ice Duration - Madison Lakes Area 1853 - current](https://portal.edirepository.org/nis/mapbrowse?scope=knb-lter-ntl&identifier=33&revision=37)

```{=html}
<!-- consider thia other data package: [Fiddler crab body size in salt marshes from Florida to Massachusetts, USA at PIE and VCR LTER and NOAA NERR sites during summer 2016](https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-pie.540.1) OR
...
1.  Open our [Data Package Assessment Rubric](https://docs.google.com/document/d/1PQpw9ohOMY7K1yBWaknMHV0dGEm0GnZ9pCB8_i2JPoU/edit?usp=sharing) and make a copy of it to:
