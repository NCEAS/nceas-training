...
The ultimate goal of this lesson is to provide an overview of a reproducible open science framework for your research. Either you are accessing published data (data user) to -- for example use it for synthesis or you want to publish your own data (data author), it is necessary to learn about:
...
These topics interconnect with each other and can be use and apply simultaneously.


## The Data Life Cycle

The Data Life Cycle gives you an overview of meaningful steps in a research project. This step-by-step breakdown, facilitates successful management and preservation of data throughout a project. It is not necessary for researchers to move through the data life cycle in a cyclical fashion and some research activities might use only part of the life cycle. For instance, a project involving meta-analysis might focus on the Discover, Integrate, and Analyze steps, while a project focused on primary data collection and analysis might bypass the Discover and Integrate steps. 
...
A first step to working with data is identifying where in the Data Life Cycle my project is starting at. Using the steps of the data life cycle, create your own cycle that fits best your project needs.
...
No matter how your data life cycle looks like, _Plan_ should be at the top of the the cycle as it is advisable to initiate your data management planning at the beginning of your research process, before any data has been collected or discovered. In the next section will discuss more in-depth about data management and how to plan accordingly.
...
-   **Include tidy and ethical lens:** It is important to start thinking through this lenses during the planning process of your DMP, it will make it easier to include and maintain tidy and ethical principles throughout the entire project. We will discuss in depth about [tidy data](https://learning.nceas.ucsb.edu/2023-06-delta/session_09.html), [FAIR principles](https://learning.nceas.ucsb.edu/2023-06-delta/session_16.html#what-is-fair) and data ethics though the [CARE principles](https://learning.nceas.ucsb.edu/2023-06-delta/session_16.html#what-is-care) latter this week.
