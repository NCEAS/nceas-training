...
### A Note on Community Principles: CARE and FAIR 
...
1. (meta)data are retrievable by their identifier using a standard communicaitons protocol
1. the protocol is open, free, and universally implementable
1. the protocol allows for an authentication and authorization procedure, where neccesary
1. metadata are accessible, even when the data are no longer available

The [CARE Principles](https://static1.squarespace.com/static/5d3799de845604000199cd24/t/5da9f4479ecab221ce848fb2/1571419335217/CARE+Principles_One+Pagers+FINAL_Oct_17_2019.pdf) for Indigenous Data Governance complement the more data-centric approach of the FAIR principles, introducing social responsibility to open data management practices. The CARE Principles stand for:
