...
We can achive practical reproducibility by:
* preserving the data
* preserving the software workflow
* providing documentation for processes
* describing how to interpret all parts
