...
-   How to organize your work using R project
-   *Supplemental objective: How to make sure your local RStudio environment is set up properly for analysis*
...
You should have received an email prompting you to change your password for your server account. If you did not, please put up a red post-it and someone will help you.

If you were able to successfully change your password, you can log in at: <https://included-crab.nceas.ucsb.edu/>

### Why use an R project? {.unnumbered}
...
-   Click "New Directory"
-   Click "New Project"
-   Under "Directory name" type: `training_{USERNAME}`, eg: `training_do-linh`
...
#### Understand how to use paths and working directories {.unnumbered}
...
#### Organizing your project {.unnumbered}
...
Currently, the only file in your project is your `.Rproj` file. This file is what contains the settings specific to your R project. Some common directories are:

-   `data`: where we store our data (often contains sub-directories for raw, processed, metadata data)

-   `R`: contains scripts for cleaning or wrangling, etc. (some find this name misleading if their work contains other scripts beyond the R programming language, in which case they call this directory `scripts`)
...
Directory organization will vary from project to project, but the ultimate goal is to create a well organized project for both reproduciblity and collaboration.
...
git config --global user.name "Halina Do-Linh"
```
