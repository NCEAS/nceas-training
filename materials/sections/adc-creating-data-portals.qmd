...
If you are on the [Arctic Data Center's primary website](http://arcticdata.io/), select the button on the top right titled 'Sign in with ORCID'. Sign in with your ORCID, which will then take you directly to the page where you can start customizing your portal.

![](images/ADC-homepage.png)
