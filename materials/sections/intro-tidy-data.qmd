...
::: callout-note
If you need to produce a publishable E-R model such as the one above, [Mermaid](https://mermaid.js.org/intro/) is a great option. Read more about how to use this tool to create diagrams [here](https://mermaid.js.org/syntax/entityRelationshipDiagram.html).
:::
