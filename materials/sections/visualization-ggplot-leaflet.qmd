...
0. Make sure you’re in the right project (`training_{USERNAME}`), create a new Quarto document, delete the default text, and save this document.
<!--
