...
```{r data-life-cycle, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'The data life cycle. Source: DataONE'}
...
```{r open-formats, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Some examples of open file formats.'}
knitr::include_graphics("images/open-formats.png")
```
...
```{r newer-version, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'What the dataset landing page will look like when a newer dataset exists.'}
knitr::include_graphics("images/newer-version.png")
```
...
```{r dataset-metrics, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'An example dataset showing the citations collected, as well as the tabs showing downloads and views.'}
knitr::include_graphics("images/dataset-metrics.png")
```
...
```{r dataset-downloads, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'An example dataset showing the downloads over time.'}
knitr::include_graphics("images/dataset-downloads.png")
```
...
To register a citation, navigate to the dataset using the DOI and click on the citations tab. Once there, this dialog box will pop up and you'll be able to register the citation with us.

```{r register-citation, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Register citation button on an Arctic Data Center dataset.'}
knitr::include_graphics("images/register-citation.png")
```

Click that button and you'll see a very simple form asking for the DOI of the paper and if the paper **CITES** the dataset (that is, the dataset is explicitly mentioned somewhere in the text) or **USES** the dataset (that is, uses the dataset but doesn't formally cite it).

```{r register-citation2, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Register citation form.'}
knitr::include_graphics("images/register-citation2.png")
```
...
```{r provenance, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'This data table in the middle has four sources of raw data on the left, and is used to create the two visualizations on the left.'}
knitr::include_graphics("images/provenance.png")
```
