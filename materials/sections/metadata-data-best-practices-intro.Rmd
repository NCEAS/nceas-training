...
```{r data-life-cycle, echo=FALSE, eval=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'The data life cycle. Source: DataONE'}
knitr::include_graphics("../images/data-life-cycle.png")
```
...
```{r open-formats, eval=FALSE, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Some examples of open file formats.'}
...
We encourage you to make this part of your workflow.

### Provanance & Preserving Computational Workflows

In an effort to make data more reproducible, datasets also support provenance tracking. With provenance tracking, users of the Arctic Data Center can see exactly what datasets led to what product, using the particular script that the researcher ran.
