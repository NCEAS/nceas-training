...
![](images/arctic-data-center/disciplines_2 (1).jpg)
...
![](images/arctic-data-center/ADC-filetypes-2026.png)

We also have data that spans the entire Arctic, as well as the sub-Arctic, regions.

![](images/arctic-data-center/adc-catalogue-map.png)
...
![](images/arctic-data-center/ADC-search-screenshot.png)
...
![](images/arctic-data-center/adc-dataset-2026.png)
...
We strive to keep our fingers on the pulse of what researchers like yourselves are looking for in terms of support. We’re active on [Twitter](https://twitter.com/arcticdatactr) and [BlueSky](https://bsky.app/profile/arcticdatactr.bsky.social) to share Arctic updates, data science updates, and specifically Arctic Data Center updates, but we’re also happy to feature new papers or successes that you all have had with working with the data. We can also take data science questions if you’re running into those in the course of your research, or how to make a quality data management plan. Follow us on our media platforms and interact with us – we love to be involved in your research as it’s happening as well as after it’s completed.
...
![](images/arctic-data-center/adc-metrics-2026.png)
