...
contentid::sources(delta_catch_id, cols=c("identifier", "source", "date", "status", "sha1", "sha256"))
```
...
### Bonus: Improvements to content identifiers
