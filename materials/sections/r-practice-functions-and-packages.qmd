...
1. Create a new project using the R Package template by selecting: ```File -> New Project -> New Directory -> R Package -> Create Project```. In the R Package dialog box, type "aboutMe" in the "Package Name:" field.
...
Add dependencies to the `DESCRIPTION` file as needed using...
