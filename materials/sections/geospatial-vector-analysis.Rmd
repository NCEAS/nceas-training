...
1. Navigate to [this dataset](https://dev.nceas.ucsb.edu/view/urn:uuid:6f07cb25-a4a1-48e8-95cb-74f532f3ce2d) and download the zip folder.
2. Unzip the file and move the folder created to the top level of your git repository.
3. Open your .gititnore file and add that directory to the list of things to ignore.
4. Save and commit the changes to your .gitignore.
...
ak_regions <- read_sf("../datashapefiles/ak_regions_simp.shp")
...
```{r}
pop <- read.csv("../datashapefiles/alaska_population.csv")
```
...
```{r}
rivers_3338 <- read_sf("../datashapefiles/ak_rivers_simp.shp")
st_crs(rivers_3338)
```
