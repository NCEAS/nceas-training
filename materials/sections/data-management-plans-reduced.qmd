...
Currently, the ['NSF Public Access Plan 2.0'](https://new.nsf.gov/public-access) recently went through public comment, and proposes that DMPs be renamed to Data Management and Sharing Plans (DMSP) and include requirements to ensure that data is submitted to data repositories. Any new requirements will be shared with researchers once this plan goes into effect.
