...
![](/materials/images/tidy-data-images/tidy_data/tidy_data.png)
...
![](images/tidy-data-images/data_normalization/normalized.png)
...
![](images/tidy-data-images/relational_data_models/primary_foreign_keys.png)
...
![](images/tidy-data-images/relational_data_models/surrogate_natural_keys.png)
...
There are different advantages and disadvantages to choosing surrogate, natural, or compound keys as primary keys. You can read more about this in [this article](https://www.databasestar.com/database-keys/).

### Entity-Relationship models

An **Entity-Relationship model (E-R model)** is a way to draw a compact diagram that reflects the structure and relationships of the tables in a relational database. These can be particularly useful for big databases that have many tables and complex relationships between them.
...
![](images/tidy-data-images/relational_data_models/ER_diagram_1.png)

*Step 2: Add variables for each entity and identify keys.*
Add the variables as a list inside each box. Then, identify the primary and foreign keys in each of the boxes. To visualize this, we have indicated the primary key of each entity in red and any foreign keys in blue.

![](images/tidy-data-images/relational_data_models/ER_diagram_2.png)
...
![](images/tidy-data-images/relational_data_models/ER_diagram_3.png)
...
![](images/tidy-data-images/relational_data_models/ER_diagram_4.png)
...
![](images/tidy-data-images/relational_data_models/ER_diagram_5.png)
...
![](images/tidy-data-images/merging_data/join-venn.png)

We suggest [this resource]( https://r4ds.had.co.nz/relational-data.html#join-problems) for more examples and best practices about joins.
...
Choose the primary key for each table based on your understanding of the data and take efficiency into account. Once you choose a column as the primary key, make sure that all the values in that column are there! 
...
Tidy data is one very important step to data management best practices. However there is more to consider. Here we provide some **extra advice** from a great paper called 'Some Simple Guidelines for Effective Data Management' [REF](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1890/0012-9623-90.2.205):
