...
the command prompt (e.g., `jclark@included-crab:~$`) which just shows that the computer is ready to accept a command.
...
repository page and copy the repository clone URL:
