...
- publishing data on the Collaborative Indigenous Research Digital Garden (CIRDG)
- describe and consider the ethical research practices in your work
- For instance, practicing CARE in data collection requires defining cultural metadata and recording provenance
