...
-   **If you can't find the data, how can you reuse it?** To make your data and research as findable and as accessible as possible, it's crucial that you are providing rich metadata. Consider using a field-specific metadata standard (i.e. EML or Ecological Metadata Language for earth and environmental sciences). Add a globally unique identifier (i.e. a Digital Object Identifier) to your datasets. We'll be discussing more metadata best practices in a [later lesson](https://learning.nceas.ucsb.edu/2023-04-coreR/session_14.html), but it's important to understand that quality metadata goes a long way in making your data FAIR. To help with this, researchers use a workflow called the [**FAIRification process**](https://www.go-fair.org/fair-principles/fairification-process/).
