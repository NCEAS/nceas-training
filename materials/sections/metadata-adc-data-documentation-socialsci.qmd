...
![](images/editor-03.png) ![](images/editor-04.png)
...
![](images/editor-18.png) The **Attributes** tab is where you
enter variable (aka attribute) information, including:

-   variable name (for programs)
-   variable label (for display)

![](images/editor-19.png) - variable definition (be
specific) - type of measurement ![](images/editor-20.png) -
units & code definitions

![](images/editor-21.png) You'll need to add these definitions
...
![](images/editor-23.png) After you get the big green success
...
![](images/editor-13.png) The linkage to the source dataset
should appear.
...
![](images/editor-17.png) The diagram now shows the
relationships among the data files, so click **Submit**
to save another version of the package.

![](images/editor-24.png) Et voilà! A beautifully preserved
data package!
