...
providing metadata.  At NEON, you will be required to published data to the [NEON Data Portal](https://data.neonscience.org/data-products/explore) or to an external data repository for specialized data (see [externally hosted data](https://www.neonscience.org/data-samples/data-management/externally-hosted-data)).  

Full information on data processing, data management and product release can be found in the online [NEON Data Management](https://www.neonscience.org/data-samples/data-management) documentation. Below is an overview of the data processing pipeline for observational data. 

<iframe width="560" height="315" src="https://www.youtube.com/embed/82-scTZsyeY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
#### Download the data to be used for the tutorial {- .setup}
