...
OK. Now let's practice with some of those commands. Delete all of the text in your RMarkdown except for the stuff in the first few rows that it formatted differently. That section is the header, which is formatted using a syntax called YAML.

Create a new chunk in your RMarkdown in one of these ways:
