...
See the Virtual Collaboration section to learn more about virtual meetings and how to run them efficiently.
...
The most important is to be **_consistent_** among collaborators and over time. To know more about this topic, here is a  good [reference](https://speakerdeck.com/jennybc/how-to-name-files) on this topic from Jenny Bryan (RStudio).
