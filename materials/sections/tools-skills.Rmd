## Skills and Tools for Reproducible and Collaborative Data-driven Science
...
*   **Document sharing**: we recommend setting up a shared drive (e.g., Box, Google Drive, ...) where you can centralize the documents that your group will gather and create. This is meant to be a solution that everyone on the team (independent of their institution) can access. Each solution as its pros and cons and mostly it will depend what your collaborators are used to. It seem Google Drive has a large user base and can be setup with very open saring settings. It can be useful if you are collaborating across institutions. See [here](https://docs.google.com/document/d/1gemd7IB5OKVPnrTIaXECYKeMoNJ6MGUNSh1ehB8Frsk/edit) NCEAS' recommendations to its working groups on best practices on how to use Google Drive.
*   **Team Communication**: The tools you will be using will depend on how you are collaborating synchronously or not (see Chapter on Virtual collaboration for more).  \
