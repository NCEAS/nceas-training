...
*   At the end of your project, where do you plan to archive your products (data produced, codes, ...)?
You will learn more about data repository and the archiving your products later in the Book

```{r data-life-cycle, out.width='80%', fig.align="center", fig.cap="Credits: DataONE data management; Friedrich Recknagel and William K. Michener. “Ecological Informatics”, 2017)", echo=FALSE}
