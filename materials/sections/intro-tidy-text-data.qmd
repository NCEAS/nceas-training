...
## Exercise: Exploring Unstructured Text Data from a PDF
...
1.  In the `intro-text-data.qmd` files create a new header for this exercise (e.g. "Exploring Unstructured Text Data from a PDF").
...
3.  Depending on which group you're in, read in one of the following chapters of the Delta Plan:
