...
-   version control software that tracks files in a folder (a repository)
-   creates the versioned history of a repository
-   maybe one more thing?

![](images/github-intro.png)

-   website that allows users to store their `Git` repositories and share them with others
-   another thing I'll add here
-   and one more thing
-   room for one more on a single line
:::
...
|                |                  |                                                                                                   |
|---------------|-------------|--------------------------------------------------------|
| Term           | Terminal Command | Definition                                                                                        |
| Add            | git add          | the process of selecting a file for inclusion in version history                                  |
| Branch         | git branch       | a separate set of changes to version history allowing users to work in parallel on the same files |
| Commit         | git commit       | a snapshot of changes to be added to version history                                              |
| Commit message | git commit - m   | user-specified description of the changes made in a commit                                        |
...
| Merge          | git merge        | combining changes that originate from different repositories or branches                          |
| Pull           | git pull         | an action that synchronises the local repository with remote changes                              |
| Push           | git push         | an action that synchronizes the remote repository with local changes                              |
