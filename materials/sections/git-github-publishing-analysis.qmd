...
2. Save the Quarto file you just created. Use `index.qmd` as the file name
...
4. Commit your changes (for both `index.qmd` and `index.html`) with a commit message, `pull` and then `push` to GitHub
