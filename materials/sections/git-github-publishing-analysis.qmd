...
In the instructions below, we'll assume you created a Quarto document called `quarto-intro.qmd` during the module on [Introduction to Quarto](../session_02.html), and have pushed that to GitHub within the same repo where you just created the `index.qmd` file above.

::: {.callout-important collapse="true"}
#### But what if I don't have a `quarto-intro.qmd` file?!?
...
If you haven't created this file at all, nor any other Quarto documents from previous modules, go ahead and create a new Quarto document in RStudio, and save it as `quarto-intro.qmd`. Just for quick illustration, add an R code chunk or two, such as:
...
<details>
  ...
  - Example: `[Introduction to Quarto](quarto-intro.html)`
</details>
