...
'qualtRics' will only enable you to download and integrate survey data that you have administrative access to. rest assured that someone else cannot use this package to read in your data. However, one limitation is that the package requires Qualtrics API access, which must be enabled in your account to use it. Depending on the type of account your have, this may require administrative approval from your brand ambassador for institutional accounts.
