...
1. **Short answer:** If numeric, you can define limits. For text you can check for a specific work or string type, e.g. URL or email. You can also define the minimum and maximum characters. 
1. **Paragraph:** Define the minimm and maximum paragraph length (in characters).  
