...
- Using RMarkdown to build a web site
- A quick overview of producing nice visualizations in R with ggplot
- Also showing how to create interactive maps with leadlet
...
You can load the data table directly from the KNB Data Repository using:
