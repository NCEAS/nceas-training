...
Then, in the documentation for any package, add the following line:
...
For an example to poke around, see a package we wrote for analysis of ecological communities: [https://github.com/NCEAS/codyn](https://github.com/NCEAS/codyn)

See how I listed an import: 
1. https://github.com/NCEAS/codyn/blob/master/DESCRIPTION#L32
2. and specifically [imported two functions](https://github.com/NCEAS/codyn/blob/master/R/variance_ratio.R#L55) from the stats package using `@importFrom`
...
- Hadly Wickham's awesome book: [R Packages](http://r-pkgs.had.co.nz/)
