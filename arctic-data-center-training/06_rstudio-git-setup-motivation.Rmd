...
```{r, eval = F}
save_packages("installed_old.rda")
```
...
```{r, eval = F}
update_packages("installed_old.rda")
```
...
If the output of this does not say `1.2.500`, you should update your RStudio. Do this by selecting Help -> Check for Updates and follow the prompts.
