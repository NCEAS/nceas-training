...
An [example lab policy](https://github.com/temporalecologylab/labgit/blob/master/datacodemgmt/tempeco_DMP.pdf) that combines data management and sharing practices with authorship guidelines from the [Wolkovich Lab](http://temporalecology.org/).
