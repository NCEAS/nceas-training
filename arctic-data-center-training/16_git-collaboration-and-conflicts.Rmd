...
both your own changes and your collaborator's changes in the file.  It delimits
these blocks with a series of less than and greater than signs, so they are easy to find:

```
<<<<<<< HEAD
The changes to the lines we made are shown here. (ours)
=======
The changes to the lines our collaborators made are below the divider. (theirs)
>>>>>>> [4305bce8d53e88959b0718354a6341869c05bdfc]
```
...
delimiter lines `<<<<<<< HEAD`, `=======`, and `>>>>>>> [4305bce8d53e88959b0718354a6341869c05bdfc]`.
