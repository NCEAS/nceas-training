# Git: Collabotation and Conflict Management
...
*Settings*. Working in pairs, and choose one person as the 'Owner' and one as the 'Collaborator'.
...
a file in the repsoitory, save it, pull to make sure no new changes have been made
...
Pull before every commit, and commit ofen in small chunks.

## Detecting a conflict

When you haven't pulled recently, you can get conflicts if your local commits occurred
from a version that was prior to the current version on the origin reppsitory.
